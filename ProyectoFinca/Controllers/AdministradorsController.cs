...
namespace ProyectoFinca.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
